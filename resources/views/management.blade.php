    ...
    <div class="container">
        ...
        <div class="members-grid">
            ...
            <div class="member-card" data-aos="fade-up">
                <img src="{{ asset('frontend/images/rector.jpg') }}" alt="Management Member">
                <h3>Rev. Dr. Kunle Ibikunle</h3>
                <p>Rector</p>
            </div>
            <div class="member-card" data-aos="fade-up" data-aos-delay="100">
                <img src="{{ asset('frontend/images/registrar.jpeg') }}" alt="Management Member">
                <h3>Pastor Mrs. Joyce O. Akaa</h3>
                <p>Registrar</p>
            </div>
            <div class="member-card" data-aos="fade-up" data-aos-delay="200">
                <img src="{{ asset('frontend/images/acad-dean.jpeg') }}" alt="Management Member">
                <h3>Rev. Dr. Mrs. Henrietta Emessiri</h3>
                <p>Academic Dean</p>
            </div>
            <div class="member-card" data-aos="fade-up" data-aos-delay="300">
                <img src="{{ asset('frontend/images/student-affrs.jpeg') }}" alt="Management Member">
            ...
            <!-- Second Row -->
            <div class="member-card" data-aos="fade-up">
                <img src="{{ asset('frontend/images/center-coordinator.jpeg') }}" alt="Management Member">
                <h3>Pastor Barr. Julie N. Okorie</h3>
                <p>Center Coordinator</p>
            </div>
            <div class="member-card" data-aos="fade-up" data-aos-delay="100">
                <img src="{{ asset('frontend/images/accountant.jpeg') }}" alt="Management Member">
